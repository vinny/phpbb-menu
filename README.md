...
[![Build Status](https://github.com/vinny/phpbb-menu/actions/workflows/tests.yml/badge.svg)](https://github.com/vinny/phpbb-menu/actions)

Header Menu extension for phpBB 3.3+ allowing administrators to create, reorder, and manage a custom navigation menu in the forum header.
