...
$lang = array_merge($lang, [
	...
	'MENU_ENABLE_EXPLAIN'				=> 'Master toggle to display or hide the header menu across your board.',
	'MENU_SEARCH'						=> 'Enable search box',
	'MENU_SEARCH_EXPLAIN'				=> 'Displays a search box on the right side of the menu and replaces the default header search box.',
	...
	'MENU_ITEM_URL_EXPLAIN'				=> 'Internal board path (e.g. index.php, viewforum.php?f=2), full URL (e.g. https://example.com), or # for dropdown items without a direct link.',
	'MENU_ITEM_URL_PLACEHOLDER'			=> 'index.php',
	'MENU_ITEM_PARENT'					=> 'Parent item',
	'MENU_ITEM_PARENT_EXPLAIN'			=> 'Select a parent item to create a submenu dropdown. Maximum hierarchy depth is 3 levels.',
	'MENU_ITEM_ICON'					=> 'Icon',
